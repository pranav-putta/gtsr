...
from display import display_peaks, display_intervals, display_RR_model, display_prediction
import pandas as pd
import yaml
...
def evaluate_model_on_validation(model: np.poly1d, config: Configuration):
